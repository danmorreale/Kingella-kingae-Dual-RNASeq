...
plot_grid(pca.plot.Replicate, pca.plot.Treatment, labels = c('A', 'B'), label_size = 12)
...
Replicate <- factor(targets$replicate)
Treatment <- factor(target2$Treatment)
Time <- factor(target2$hpi)
...
diffGenes_1.df <- as_tibble(diffGenes_1, rownames = "geneID")
diffGenes_8 <- v.DEGList.filtered.norm$E[results[,2] !=0,]
diffGenes_8.df <- as_tibble(diffGenes_8, rownames = "geneID")
diffGenes_14 <- v.DEGList.filtered.norm$E[results[,3] !=0,]
diffGenes_14.df <- as_tibble(diffGenes_14, rownames = "geneID")
diffGenes_8rel1 <- v.DEGList.filtered.norm$E[results[,5] !=0,]
diffGenes_8rel1.df <- as_tibble(diffGenes_8rel1, rownames = "geneID")
